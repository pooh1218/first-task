...
require("./app/routes/shipdata.routes")(app);
require("./app/routes/loaddata.routes")(app);
require("./app/routes/productdata.routes")(app);
require("./app/routes/gooddata.routes")(app);
...
require("./app/routes/testPurchaseHistory.routes")(app);
require("./app/routes/purchaseHistory.routes")(app);
